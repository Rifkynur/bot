  ...
  return (
    <section className="font-Montserrat relative flex h-screen w-full">
      <div className="bg-tertary sticky top-0 flex h-screen w-3/12 flex-col justify-between p-5">
        <div>
          <h1 className="mb-20 text-5xl font-bold">website bot</h1>
      ...
      <div className="flex h-screen w-full items-center bg-slate-100 px-10">
        <div className="bg-secondary flex w-[728px] flex-col gap-4 px-10 py-5">
          ...
          <div className="flex w-full items-center justify-between">
            ...
            <button className="w-fit rounded-2xl bg-slate-500 px-6 py-2 text-2xl font-semibold capitalize text-white">cancel</button>
          </div>
        </div>
      </div>
    </section>
